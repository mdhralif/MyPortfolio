        ...
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="hidden md:block text-gray-300 mb-4 font-semibold">Enrolled Courses :</p>
...
.map((skill, index) => (
        ...
        <div className="mt-6 flex items-center justify-center gap-2 w-full md:w-auto">
          <button
            onClick={() => setShowMoreEdu((s) => !s)}
            aria-expanded={showMoreEdu}
            aria-label={showMoreEdu ? "Minimize" : "My Academic Journey"}
            className="w-full md:w-auto inline-flex items-center justify-center gap-3 bg-white text-[#161825] px-4 py-2 rounded-none font-extrabold shadow-md hover:shadow-lg transition-shadow"
          >
