const Footer = () => {
  ...
  return (
    <footer className="bg-[#18181a] relative">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col items-center space-y-6">
          {/* Scroll to Top - Desktop Only */}
          <button 
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="hidden md:flex flex-col absolute left-8 bottom-8 items-center justify-center text-gray-400 hover:text-[#2DD4BF] transition-all duration-300 group"
            aria-label="Scroll to top"
          >
            <svg className="w-6 h-6 transition-transform duration-300 group-hover:-translate-y-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
